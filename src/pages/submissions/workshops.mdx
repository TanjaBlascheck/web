...
All contributions are submitted using the Precision Conference Submission System: https://new.precisionconference.com. Please select "Society" -> "Eurographics", "Conference/Journal" -> "Eurovis 2027" and then "Track" -> "EuroVis 2027 Workshops."
